  ...
  useEffect(() => {
    if (id && customers.length > 0) {
      ...
      if (foundCustomer) {
        ...
        setCompany(foundCustomer.company || '');
...
// ... inside handleUpdateCustomer function, after updateCustomer call
      await updateCustomer(customer.id, customerData);
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          ...
          <Text style={[styles.title, { color: colors.text }]}>Edit Customer</Text>
          <TouchableOpacity onPress={handleUpdateCustomer} disabled={loading}>
